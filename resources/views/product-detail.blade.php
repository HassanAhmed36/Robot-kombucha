        ...
        <div class="mx-auto my-3 py-5">
            <div class="row my-5">
                ...
                <div class="col-lg-8 col-12 ps-4 mt-4">
                    ...
                    <div class="mt-5">
                        @if ($setting->payment_active == 1)
                            <a href="{{ route('checkout', ['id' => $product->id]) }}" class="btn rounded-4 px-4 me-3"
                                style="border:1px solid #324446; background-color: #41F2C0;" id="add_to_cart"><i
                                    class="fa-solid fa-cart-shopping me-1"></i>Buy Now</a>
                        @else
                            <p>Product Not Avalible yet</p>
                        @endif
                    </div>
                </div>
            </div>
